...
int main()
{
    ...
    printf("Console de type E connectee a gestion_console.\n");

    // Envoi du message d'identification
    MessageTemperature identification;
    strcpy(identification.piece, "ConsoleTYPE=E"); //Je copie la chaine
    ...
    printf("En attente des messages de Temperatures ...");
